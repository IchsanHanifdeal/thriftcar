    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{ date('Y') }} <a href="https://www.tiktok.com/@nico.j.t" target="_blank">Thrift Auto Car</a>.</strong>
        All rights reserved.
        <div class="float-right d-none d-sm-inline-block">
            Designed By <b>Nico Jonathan</b>
        </div>
    </footer>
    </div>
    <!-- ./wrapper -->
