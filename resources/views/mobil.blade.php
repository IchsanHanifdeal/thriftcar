        ...
        <div class="modal-content">
            ...
            <form action="{{ route('tambah_mobil') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mt-2 mb-2">
                            <input type="text" placeholder="Nama Mobil" name="nama_mobil" id="nama_mobil" class="form-control" required>
                        </div>
                        <div class="col-md-4 mt-2 mb-2">
                            <input type="text" placeholder="Tipe Mobil" name="tipe_mobil" id="tipe_mobil" class="form-control" required>
                        </div>
                        <div class="col-md-4 mt-2 mb-2">
                            <input type="text" placeholder="Merk Mobil" name="merk_mobil" id="merk_mobil" class="form-control" required>
                        </div>
                        <div class="col-md-6 mt-2 mb-2">
                        ...
                        <div class="col-md-6 mt-2 mb-2">
                            <input type="number" placeholder="Stok" name="stok" id="stok" class="form-control" required>
                        </div>
                        <div class="col-md-6 mt-2 mb-2">
                            <input type="number" placeholder="Harga" name="harga" id="harga" class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <div class="custom-file">
                                <input type="file" name="gambar" id="gambarTambah" class="custom-file-input" onchange="previewImage(event, 'tambah')" required>
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        <button type="button" class="btn btn-secondary btn-sm mr-2 ml-2" data-dismiss="modal">Tutup</button>
